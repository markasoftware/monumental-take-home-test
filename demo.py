...
from placer import unstrided_placement_order
...
placeable_bricks = brick_list_to_placeable_brick_list(5, 5, bricks)
placement_order = unstrided_placement_order(placeable_bricks)
